...
export function QuestionnaireForm({
  ...
  // Auto-fill from site intel if no existing responses
  const autoClimate =
  ...
  const [responses, setResponses] = useState<Record<string, string>>({
    // Step 0: Building Classification
    ...
    // Step 7: Access & Livable Housing (H5/H8)
        ...
        <CardContent className="space-y-4">
          ...
          {step === 1 && (
            <>
              ...
              <SelectField
                ...
                autoTag={!!autoWind && responses.wind_classification === autoWind}
              />
              <SelectField
          ...
          {step === 2 && (
            <>
              ...
              />
              <CheckboxField
                label="Roof sarking installed"
                checked={responses.sarking === "true"}
                onChange={(v) => update("sarking", String(v))}
              />
              <CheckboxField
                label="Sub-floor ventilation required"
          ...
          {step === 6 && (
            <>
              <SelectField
                ...
                autoTag={!!autoClimate && responses.climate_zone === autoClimate}
              />
              <SelectField
                ...
                options={BAL_RATINGS}
                autoTag={!!autoBal && responses.bal_rating === autoBal}
              />
              <TextField
