...
// While the case studies are switched off, ask search engines not to index
// the page. Hiding the navigation links alone would leave these claims live
// and findable — quieter, but just as published.
